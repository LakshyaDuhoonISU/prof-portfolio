...
export const projects: Project[] = [
  ...
  },
  {
    ...
    severity: 'High',
    status: 'Operational',
    description: 'A full-stack API monitoring platform capable of continuously monitoring REST APIs through scheduled health checks, validating responses, tracking uptime and latency, detecting outages, managing incidents, visualizing historical performance metrics, and generating operational reports.',
    problemStatement: 'Organizations lack visibility into the real-time health and performance of their critical API infrastructure, leading to prolonged downtime.',
    solution: 'Built a comprehensive observability tool that performs automated health checks, alerts on failures, and provides detailed metrics visualization.',
    techStack: ['React', 'TypeScript', 'Node.js', 'Express', 'MongoDB', 'Ant Design', 'Recharts'],
    features: [
      'Scheduled automated health checks',
      'Real-time uptime and latency tracking',
      'Incident management and alerting',
      'Historical performance metrics visualization',
      'Automated operational report generation',
    ],
    challenges: ['Handling high-frequency concurrent polling', 'Storing and querying large time-series datasets', 'Minimizing false positive outage alerts'],
